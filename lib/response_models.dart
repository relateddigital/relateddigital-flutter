...
class PayloadListResponse {
  late List<Payload> payloads;
  String? error;

  PayloadListResponse(this.payloads, this.error);

  PayloadListResponse.fromJson(Map<dynamic, dynamic> json) {
    payloads = [];
...
class RDTokenResponseModel {
  ...
  late bool playServiceEnabled;

  RDTokenResponseModel.fromJson(Map<String, dynamic> json) {
    deviceToken = json['deviceToken'] ?? '';
    playServiceEnabled =
        Platform.isIOS ? true : (json['playServiceEnabled'] ?? true);
  }
}
